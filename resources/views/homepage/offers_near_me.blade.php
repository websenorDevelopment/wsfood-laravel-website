...
@include('swiggy_layouts.secondNavbar')
    ...
    <div class="container food_cards_container">
        <div class="row home_row  ">
            <h6>Home <span>/Offers</span>
                <div class="heading">Restaurants With Great Offers Near Me</div>
            </h6>
        </div>
        ...
        <div class="row card-row ">
            <div class=" d-flex justify-content-center mb-4  ">
                <div class="card" style="width: 18rem;">
                    <img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2024/7/28/6ce8b5f3-f39c-491e-874b-2341ab459d8d_86858.jpg"
                        class="card-img-top" height="200px" width="100px" alt="...">
                    ...
                    <div class="card-body">
                        <div class="card-name">Royal Punjabi(Pure Veg)
                        ...
                        <div class="card-time"><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                </svg></span>4.1 • 30-35 mins

                        </div>
                        <div class="card-address">North Indian, Biryani, Thalis, Tandoor, Chinese,
                            Punjabi
                            Hiran Magri
                        </div>
                    </div>
    ...
    <div class="container text-container border">
        ...
        <div class="inner_text">Get ready for a scrumptious adventure filled with unbeatable offers on your favourite foods and
           ...
           All the top-rated restaurants and popular eateries are rolling out enticing deals and discounts that are too
            ...
            worrying about the bill? With these incredible offers, indulging in your beloved dishes has never been more
            budget-friendly.

            So, whether you're planning a cosy night in, a family feast, or a fun dinner with friends, take advantage of
            these fantastic deals. It's time to savour the flavours you adore without emptying your wallet. Order now,
            support your local restaurants, and make every meal a delightful and cost-effective experience. Don't miss
